...
{
    public partial class FrmMainFormHis : Form
    {
       // public Dictionary<string, HistogramResult> DicPicture = new Dictionary<string, HistogramResult>();
        ...
        private string FileDataName = "/DataFileHis.json";
        private string FileDistance = "/DataDistanceHis.json";
        private List<ImageFile> _directory = new List<ImageFile>();

        private List<ImageGrid> _listDisPlay = new List<ImageGrid>();


        public FrmMainFormHis()
        {
            InitializeComponent();
                    ...
                    _directory.Add(new ImageFile
                        {
                            ...
                            Index = index,
                            Color = HistogramUtils.GetMatrix(histogramResult.Histogram, histogramResult.RedColor, histogramResult.CumulativeHistogram,true)
                        });
                    index++;
